...
export default function TopHeaderCard({ channel }: Props) {
  ...
  return (
    <div className="w-full grid grid-cols-1 md:grid-cols-3 gap-4 pb-6">

      {/* LEFT CARD — Profile */}
      <div className="bg-white p-6 rounded-2xl border border-[#eee] flex items-center gap-5">
        <Image
      ...
      {/* RIGHT CARD — Stats */}
      <div className="bg-white p-6 rounded-2xl border border-[#eee] md:col-span-2 flex justify-between gap-8 items-center">

        <div className="flex flex-col gap-1">
          <span className="text-base font-medium text-gray-600">Subscribers</span>
        ...
        <div className="flex flex-col gap-1">
          <span className="text-base font-medium text-gray-600">Videos</span>
          <span className="text-3xl font-semibold text-gray-900 tracking-tight">
        ...
        <div className="flex flex-col gap-1">
  <span className="text-base font-medium text-gray-600">Created On</span>
  <span className="text-3xl font-semibold text-gray-900 tracking-tight">
    {date}
  </span>
</div>
