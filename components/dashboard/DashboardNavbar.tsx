...
export default function DashboardNavbar() {
  ...
  const handleCompare = async () => {
    ...
    if (!session) {
      alert("این ویژگی فقط برای کاربران پرو فعال است. لطفا وارد شوید یا ارتقا دهید.");
      return;
    }
    ...
    if (profile.plan === "free") {
      if (confirm("این ویژگی فقط برای کاربران پرو فعال است. می‌خواهید حساب خود را ارتقا دهید؟")) {
        router.push("/pricing"); // صفحه پرداخت یا پرایسینگ
      }
      return;
    }
