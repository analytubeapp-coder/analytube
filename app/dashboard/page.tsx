  ...
  return (
    <div className="space-y-10 text-white max-h-[70vh] overflow-y-auto pr-4">
      ...
      <div>
        ...
        {risks.length === 0 ? (
          <p className="text-white/50 text-sm mt-2">No risks found.</p>
        ) : (
      ...
      <div>
        ...
        {roles.length === 0 ? (
          <p className="text-white/50 text-sm mt-2">No suggested roles.</p>
        ) : (
          <div className="space-y-4">
...
function InsightBlock({ title, list }: any) {
  return (
    <div>
      ...
      {list.length === 0 ? (
        <p className="text-white/50 text-sm mt-2">No items available.</p>
      ) : (
